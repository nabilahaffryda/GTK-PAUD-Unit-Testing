...
return [
    ...
    */
    'resources' => [
        'akuns'                  => \App\Models\Akun::class,
        'akun_instansis'         => \App\Models\AkunInstansi::class,
        'instansis'              => \App\Models\Instansi::class,
        'm_berkas_pauds'         => \App\Models\MBerkasPaud::class,
        'm_groups'               => \App\Models\MGroup::class,
        'm_verval_pauds'         => \App\Models\MVervalPaud::class,
        'paud_admins'            => \App\Models\PaudAdmin::class,
        'paud_akseses'           => \App\Models\PaudAkses::class,
        'paud_group_akseses'     => \App\Models\PaudGroupAkses::class,
        'paud_instansis'         => \App\Models\PaudInstansi::class,
        'paud_instansi_berkases' => \App\Models\PaudInstansiBerkas::class,
        'ptks'                   => \App\Models\Ptk::class,
    ],
