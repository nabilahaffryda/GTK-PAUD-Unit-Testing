...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'paspor-dev.simpkb.id'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'paspor-dev.simpkb.id,172.17.1.46'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://paspor-dev.simpkb.id/cas/logout'),
